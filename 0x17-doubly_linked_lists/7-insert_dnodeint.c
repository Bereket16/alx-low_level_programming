...
dlistint_t *insert_dnodeint_at_index(dlistint_t **h, unsigned int idx, int n)
{
	...
	while (current != NULL)
	{
ts in a doubly linked list
  * @h: The double link		if (iter_times == idx)
		{
...
/**
  * create_node - Create a n			return (new_node);
		}
...
/**
  * dlistint_len - Counts the number of elemened list to count
  *
